...
int main()
{
    ...
    // Declaraci�n de listas para variables e instrucciones -------
                    ...
                    if(EvaluaBooleano(var,c)){
                      switch(BuscarPalabra(f)){
                            ...
                            case 4:// si hay que hacer un jump
                                    ...
                                    while(i<aux){instr = instr->resto(); i++;} // mientras no se llegue a la l�nea que pide en el JUMP, itera los nodos
                                    break;
